...
const Profile = () => {
    ...
    const [securityData, setSecurityData] = useState({ currentPassword: '', newPassword: '', enable2FA: user?.twoFactorEnabled || false });
    ...
    const handleAction = (feature) => {
        ...
        if (feature === 'Security Settings') {
            setSecurityData({ currentPassword: '', newPassword: '', enable2FA: user?.twoFactorEnabled || false });
    ...
    const handleSecuritySubmit = async (e) => {
        ...
        setLoading(true);
        setTimeout(() => {
            const res = updateSecurity(securityData.currentPassword, securityData.newPassword, securityData.enable2FA);
            setLoading(false);
            if (res.success) {
